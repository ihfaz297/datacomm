...
if ok:
    ...
    for a, sig, name in zip(ax, (sine, square, triangle), ("sine", "square", "triangle")):
        a.plot(t, sig); a.set_title(f"{name} wave, f = {f} Hz, {periods} periods"); a.set_ylabel("amplitude"); a.grid(alpha=.3)
